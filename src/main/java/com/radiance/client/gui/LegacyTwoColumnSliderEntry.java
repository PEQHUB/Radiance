...
public class LegacyTwoColumnSliderEntry extends OptionListWidget.WidgetEntry {
    private final List<ClickableWidget> widgets;

    public LegacyTwoColumnSliderEntry(ClickableWidget left, ClickableWidget right,
