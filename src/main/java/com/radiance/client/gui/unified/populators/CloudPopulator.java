...
public class CloudPopulator implements ContentPopulator {
    ...
    public void populate(ContentPanelWidget panel, RadianceUnifiedScreen screen) {
        ...
        // Quality dropdown (6 values) + Scatter Bounces cycling (4 values)
        ...
        volModule.tooltip("Quality = overall cloud resolution. Scatter = light bounce count (higher = more realistic).");
